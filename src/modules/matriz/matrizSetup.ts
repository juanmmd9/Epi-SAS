export const SQL_MIGRACION_MATRIZ = `-- Matriz de conocimientos y habilidades
...
export function faltaTablaMatriz(mensaje: string): boolean {
  return /competencias_matriz|matriz_conocimiento|schema cache|relation.*does not exist/i.test(
    mensaje,
  );
}
